  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Path
          {...this.props}
          colorstyle="svg-dark-stroke-animation"
          fill="none"
          stroke="#4A4A49"
          strokeWidth="2"
          strokeMiterlimit="10"
