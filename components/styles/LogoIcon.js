...
const Circle = styled(({ rotation, ...rest }) => (
  <circle rotation={rotation} {...rest} />
))`
...
class LogoIcon extends Component {
  ...
  googlyEyes = event => {
    const { left, right } = this.eyePositions;
    let x = event.pageX;
    let y = event.pageY;
    let xLeft = x - left.cx;
    let yLeft = y - left.cy;
    let xRight = x - right.cx;
    let yRight = y - right.cy;
    ...
    return (
      <div rotation={leftEyeRotation}>
        ...
        >
          ...
          />
          <path
            className="stroke-animation svg-dark-stroke"
            fill="none"
            stroke="#4A4A49"
            strokeWidth="2"
            strokeMiterlimit="10"
          ...
          <Circle
            ...
            fill="orange"
          />
          <circle r="10" cx="142" cy="50" fill="orange" />
        </svg>
